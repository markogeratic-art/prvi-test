...
# API funkcije
# Ta primer prikazuje POST zahtevo, ki uporablja parametre poti in poizvedbe, podobno kot GET
# POST je običajno namenjen za pošiljanje podatkov na strežnik, medtem ko GET pridobiva podatke
@app.post("/api/hello/{name}", summary="Sporočilo", tags=["API"])
