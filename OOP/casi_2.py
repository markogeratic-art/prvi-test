...
if __name__ == '__main__':
    ...
    print(kosilo)
    print(spat.plus(120))
    print(zajtrk.plus(-500))
    print()

    print(kosilo.razlika(zajtrk)) # 340
    print(zajtrk.razlika(kosilo)) # -340
    print(Cas(10, 10).razlika(Cas(10, 30))) # -20
    ...
    print(spat.je_manjsi_od(vecerja))   # False
    print(kosilo.je_manjsi_od(kosilo))  # False
    print(kosilo.je_manjsi_ali_enak_kot(kosilo)) # True
